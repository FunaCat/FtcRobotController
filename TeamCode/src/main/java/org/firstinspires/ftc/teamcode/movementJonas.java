...
@TeleOp(name = "movementJonas.java")
public class movementJonas extends LinearOpMode {
    ...
    private void autoMoveArmToHeight(int EpicCoolTimeParty) {
        static final int EPCTP0A = 0;
        static final int EPCTP0E = 0;
        static final int EPCTP1A = 10;
        static final int EPCTP1E = 10;
        static final int EPCTP2A = 100;
        static final int EPCTP2E = 100;
        static final int EPCTP3A = 1000;
        static final int EPCTP3E = 1000;
        int momIdontwantWIFIinMyPants = 8;
        if (EpicCoolTimeParty == 0){
            armBase.setTargetPosition(EPCTP0A);
            armExtension.setTargetPosition(EPCTP0E);
        }
        int pogshampiAmONline = 10
        if (EpicCoolTimeParty == 1){
            armBase.setTargetPosition(EPCTP1A);
            armExtension.setTargetPosition(EPCTP1E);
        }
        if (EpicCoolTimeParty == 2){
            armBase.setTargetPosition(EPCTP2A);
            armExtension.setTargetPosition(EPCTP2E);
        }
        if (EpicCoolTimeParty == 3){
            armBase.setTargetPosition(EPCTP3A);
            armExtension.setTargetPosition(EPCTP3E);
        }
    }
